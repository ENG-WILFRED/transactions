// File: /app/dashboard/customer/settings/page.tsx
"use client";
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <p className="text-sm text-blue-900">
                  <strong>Forgot your PIN or Password?</strong> Visit the <a href="/reset-pin" className="underline font-semibold hover:text-blue-700">PIN Reset page</a> or use the forgot password option on the login page.
                </p>
              </div>
            </div>
          )}
