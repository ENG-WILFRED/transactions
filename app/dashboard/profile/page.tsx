...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <DashboardLayout userType={user?.role === "admin" ? "admin" : "customer"}>
        ...
        <div className="max-w-4xl mx-auto">
              ...
              {!editing ? (
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 bg-gray-200 text-gray-700 px-4 py-3 rounded-xl hover:bg-gray-300 transition font-semibold"
                  >
                    <X size={20} />
                    Cancel
                  </button>
                  <button
                    onClick={handleSave}
                    disabled={saving}
                    className="flex items-center gap-2 bg-green-600 text-white px-6 py-3 rounded-xl hover:bg-green-700 disabled:bg-gray-400 transition font-semibold"
                  >
                    {saving ? (
                      <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    disabled={!editing}
                    className="w-full border border-gray-300 rounded-lg p-3 disabled:bg-gray-50 disabled:text-gray-600"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-white border-2 border-indigo-200 text-indigo-700 px-6 py-4 rounded-xl hover:bg-indigo-50 transition font-semibold"
            >
              <Shield size={20} />
              Security Settings
            </button>
            <button
              ...
              className="flex items-center justify-center gap-2 bg-white border-2 border-purple-200 text-purple-700 px-6 py-4 rounded-xl hover:bg-purple-50 transition font-semibold"
            >
              <CreditCard size={20} />
              My Accounts
            </button>
