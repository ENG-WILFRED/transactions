    ...
    <>
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-3 rounded-xl text-gray-300 hover:bg-gray-800 transition-all"
        >
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-[60] p-2 bg-gray-900 text-white rounded-xl shadow-lg hover:bg-gray-800 transition-all"
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-gray-900 fixed left-0 top-0 bottom-0 border-r border-gray-800 z-40">
        <SidebarContent />
      </aside>

      {/* Sidebar - Mobile (Slide In/Out) */}
      <aside
        className={`lg:hidden fixed top-0 left-0 z-[50] w-64 bg-gray-900 h-screen border-r border-gray-800 transform transition-transform duration-300 ease-in-out flex flex-col ${
